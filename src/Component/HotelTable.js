    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await axios.put(
          `http://localhost:8088/hotels/zte/${editedHotel.id}`,
          formData,
          {
            headers: {
          ...
          <div className="cm">
            <div className="cmc">
              <div className="headform">
                ...
                <button onClick={() => toggleVisibility(hotel.id)} readOnly>
                  {" "}
                  X
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="form">
                ...
                <button type="submit" disabled={isDisabled}>
                  {" "}
                  <GrUpdate className="icon"></GrUpdate>modifier{" "}
                </button>
              </form>
            </div>
          </div>
          ...
          <div className="cm">
            <div className="cmc hotelview">
              <div className="headform" style={{}}>
                ...
                <button onClick={() => toggleVisibilityView(hotel.id)} readOnly>
                  {" "}
                  X
                </button>
              </div>
              <div className="hotelbody">
                <div className="hotelimage">
                  <img
                    src={`data:image/png;base64,${hotel.imageBase64}`}
                ...
                <div className="hotelinfo">
                  <p>
                    <span>Identifiant d'hotel :</span>
                    {hotel.id}
                  </p>
                  <p>
                    {" "}
                    <span>ville d'hotel :</span>
                    {hotel.ville}
                  </p>

                  <p>
                    <span>adresse d'hotel :</span>
                    {hotel.adresse}
                  </p>

                  <p>
                    <span>nombre de chambres:</span>
                    {hotel.chambreIds.length}
                  </p>
                  <p>
                    <span>Ranking:</span>
                    {hotel.chambreIds.length}
